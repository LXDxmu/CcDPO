...
SFT_MODEL="/home/tione/notebook/lxd/data_2/lxd/model_pth/llava-onevision-qwen2-7b-ov"
EPOCH=1
beta=0.1

DPO_RUN_NAME="llava-onevision-qwen2-7b-ov-beta${beta}-epoch${EPOCH}_CcDPO_stage1"
DPO_CLEAN_NAME="${DPO_RUN_NAME##*/}"
OUTPUT_DIR="./ckpt/${DPO_CLEAN_NAME}"
DATA_PATH=“MultiScope-42k/stage1/stage1.json”

echo $DPO_RUN_NAME

ACCELERATE_CPU_AFFINITY=1 torchrun --nproc-per-node=8 --master_port 31951 \
    llava/train/train_vdpo.py \
