...
from llava.train.llava_trainer import LLaVADPOTrainer, LLaVADPOTrainer_Vision
...
def train(attn_implementation=None):
    ...
    if training_args.lora_enable:
        ...
        # #'/opt/ml/input/data_2/lxd/youtu/CHiP_ov_ablation/ckpt/llava-onevision-qwen2-7b-ov-beta0.1-epoch1_1234_stage1_13k_ablation'
        # #'/opt/ml/input/data_2/lxd/youtu/CHiP_ov_ablation/ckpt/llava-onevision-qwen2-7b-ov-beta0.1-epoch1_1234_stage1_13k_stage2_11k_ablation'
        # #'/opt/ml/input/data_2/lxd/youtu/CHiP_ov_ablation/ckpt/llava-onevision-qwen2-7b-ov-beta0.1-epoch1_1234_stage1_13k_1_ablation/checkpoint-100'
        # #'/opt/ml/input/data_2/lxd/youtu/CHiP_ov_ablation/ckpt/llava-onevision-qwen2-7b-ov-beta0.1-epoch1_1234_stage1_13k_1_stage2_11k_ablation'
        # '/opt/ml/input/data_2/lxd/youtu/CHiP_ov_ablation/ckpt/llava-onevision-qwen2-7b-ov-beta0.1-epoch1_1234_stage1_13k_1_epoch1_stage2_11k_ablation'
        # )
        # model = model.merge_and_unload()
        # model.save_pretrained("/opt/ml/input/data_2/lxd/model_pth/llava-onevision-qwen2-7b-ov-1234-epoch1-13k-1-stage2-11k-ablation")
    ...
    trainer = LLaVADPOTrainer_Vision(
        model,
        ref_model,
        args=training_args,
